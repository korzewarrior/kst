...
static const char *colorname[] = {
	...
	"#d3d7cf", /* foreground */
	"#000000", /* background */
	"#cc0000", /* selection color - same as the red color */
};

/* Default colors (colorname index) */
unsigned int defaultfg = 256;
unsigned int defaultbg = 257;
unsigned int defaultcs = 258;  /* Selection color - using our explicit red defined at index 258 */
static unsigned int defaultrcs = 258;  /* Reverse selection color */
